      ...
      <section id="slider">
         <div
            ...
            {slides.map((slide, index) => (
               <div key={index} className="slide flex-justify-align-center config-background-url">
                  <div id="overlay"></div>
                  <div className="conteudo-slide flex-justify-align-center">
                     <h2 className="titulo-slide">{slide.titulo}</h2>
                     <p className="paragrafo-slide">{slide.conteudo}</p>
                  </div>
               </div>
            ))}
         </div>
         ...
         <div
            id="conteiner-indicador-slide"
            className="flex-justify-align-center">
            <div
               className={`dot ${slide === 1 ? "dot-ativa" : null}`}
               onClick={() => {
                  setSlide(1);
               }}></div>
            <div
               className={`dot ${slide === 2 ? "dot-ativa" : null}`}
               onClick={() => {
                  setSlide(2);
               }}></div>
            <div
               className={`dot ${slide === 3 ? "dot-ativa" : null}`}
               onClick={() => {
                  setSlide(3);
               }}></div>
            <div
               className={`dot ${slide === 4 ? "dot-ativa" : null}`}
               onClick={() => {
                  setSlide(4);
               }}></div>
         </div>
